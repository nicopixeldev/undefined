...
describe('logic' , () => {
    ...
    describe('searchItems' , () => {    
        ...
        it('should succeed on mathing query' , () => {
            const query = 'titanic'
            return logic.searchVideos(query, 12)
            .then(items => {
        ...
        it('should fail on empty query' , () => {
            const query = ''
            expect(() => logic.searchVideos(query)).toThrowError('query cannot be empty')
           
        })

        it('should fail on undefined query' , () => {
            const query = undefined
            expect(() => logic.searchVideos(query)).toThrowError(TypeError, `${query} is not a string`)
    ...
    describe('retrieveItem' , () => {
        ...
        it('should fail on empty videoId', () => {
            ...
            expect(() => logic.retrieveVideo(videoId)).toThrowError('videoId cannot be empty')
        })


        it('should fail on undefined videoId' , () => {
            const videoId = undefined
            expect(() => logic.retrieveVideo(videoId)).toThrowError(TypeError, `${videoId} is not a string`)
    ...
    describe('registerUser' , () => {
        ...
        it('should fail when name is undefined' , ()  => {
            ...
            expect(() => logic.registerUser(name,surname,email,password)).toThrowError(TypeError, `${name} is not a string`)
        })
        ...
        it('should fail when surname is undefined' , ()  => {
            ...
            expect(() => logic.registerUser(name,surname,email,password)).toThrowError(TypeError, `${surname} is not a string`)
        ...
        it('should fail when email is undefined' , ()  => {
            ...
            expect(() => logic.registerUser(name,surname,email,password)).toThrowError(TypeError, `${email} is not a string`)
        ...
        it('should fail when password is undefined' , ()  => {
            ...
            expect(() => logic.registerUser(name,surname,email,password)).toThrowError(TypeError, `${password} is not a string`)
        ...
        it('should fail when passwordConfirmation is empty' , ()  => {
            ...
            expect(() => logic.registerUser(name,surname,email,password, passwordConfirmation)).toThrowError('passwordConfirmation cannot be empty')
        ...
        it('should fail when passwordConfirmation is undefined' , ()  => {
            ...
            expect(() => logic.registerUser(name,surname,email,password, passwordConfirmation)).toThrowError(TypeError, `${passwordConfirmation} is not a string`)
    ...
    describe('toogleFavorites' , () => {
        ...
        it('should succeed on correct data' , () => {
            ...
            .then(()=> logic.loginUser(email,password).then(()=> {
                return logic.toggleFavorties('id-film-123').then((user) => {
                    expect(user.favorites[0]).toBe('id-film-123')
                })
            }))
        })
    })
    ...
    describe('userLoggedIn', () => {
        const isLoggedin = logic.userLoggedIn
